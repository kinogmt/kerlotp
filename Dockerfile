...
RUN dnf install -y gcc tar make perl ncurses-devel openssl-devel patch unzip git automake autoconf procps-ng openssl-devel ncurses-devel gcc compat-openssl10-devel
RUN (mkdir -p $VVV; \
     kerl list releases; \
